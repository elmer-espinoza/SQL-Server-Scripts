...
('MARICARMEN', 'Pass456', 'maricarmen.gomez@gmail.com','Maricarmen','Gomez',     'Ventas'),
('MURIEL',     'Pass789', 'muriel.elguera@gmail.com',  'Muriel',    'Elguera',   'Logistica')
...
User ID: elmer_espinoza_SQLLogin_3
Password: 9769ood3rp
ConnString: data source=elmer-db.mssql.somee.com;user id=elmer_espinoza_SQLLogin_3;pwd=9769ood3rp;initial catalog=elmer-db;persist security info=False;workstation id=elmer-db.mssql.somee.com;packet size=4096;
