--CREATE DATABASE "Docker_SQLServer"

USE "Docker_SQLServer"
...
BEGIN 
   ...
   INSERT INTO ApiRest (Nombre, DNI, Edad, Telefono, Correo, Basico, Ingreso, Activo) VALUES
      ...
      ('KIM KATY'           ,'12345678', 23, '987654322', 'kim.katy@gmail.com',            1300.86, '2023-03-31', 1)
END
...
('shirley',    'Pass456', 'shirley.arica@gmail.com',     'Shrley',    'Arica',     'Ventas'),
('jessica',    'Pass789', 'jessica.barrantes@gmail.com', 'Jessica',   'Barrantes', 'Logistica')
